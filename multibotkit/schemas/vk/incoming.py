...
class MessageObject(BaseModel):
    ...
    random_id: int = Field(..., title="Parameter used while sending the message to avoid double sending")
    ...
    out: int = Field(..., title="Message type. 0 — received, 1 — sent. (Not returned for forwarded messages.)")
    important: bool = Field(..., title="True, whether the message is marked as important")
