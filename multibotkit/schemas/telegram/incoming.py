...
during which the location can be updated, in seconds",
    ...
    heading: Optional[int] = Field(
        None,
        title="The direction in which user is moving, in degrees; 1-360"
    )
...
class Contact(BaseModel):
    ...
    user_id: Optional[int] = Field(
        None,
        title="Contact's user identifier in Telegram"
    )
    vcard: Optional[str] = Field(
        None,
        title="Additional data about the contact in the form of a vCard"
    )
...
class Voice(FileBasedObject):
    ...
    mime_type: Optional[str] = Field(
        None,
        title="MIME type of the file as defined by sender"
    )
...
class Sticker(FileBasedObject):
    ...
    is_animated: bool = Field(
        ...,
        title="True, if the sticker is animated"
    )
    ...
    emoji: Optional[str] = Field(
        None,
        title="Emoji associated with the sticker"
    )
    set_name: Optional[str] = Field(
        None,
        title="Name of the sticker set to which the sticker belongs"
    )
...
class Video(FileBasedObject):
    ...
    file_name: Optional[str] = Field(
        None,
        title="Original filename as defined by sender"
    )
    mime_type: Optional[str] = Field(
        None,
        title="Mime type of a file as defined by sender"
    )
...
“supergroup” or “channel”",
    ...
    first_name: Optional[str] = Field(
        None,
        title="First name of the other party in a private chat"
    )
    last_name: Optional[str] = Field(
        None,
        title="Last name of the other party in a private chat"
    )
...
class User(BaseModel):
    id: int = Field(
        ...,
        title="Unique identifier for this user or bot"
    )
    is_bot: bool = Field(
        ...,
        title="True, if this user is a bot"
    )
    first_name: str = Field(..., title="User's or bot's first name")
    last_name: Optional[str] = Field(
        None,
        title="User's or bot's last name"
    )
    username: Optional[str] = Field(
        None,
        title="User's or bot's username"
    )
...
class Message(BaseModel):
    ...
    date: int = Field(
        ...,
        title="Date the message was sent in Unix time"
    )
    ...
    chat: Optional[Chat] = Field(
        None,
        title="Conversation the message belongs to"
    )
    text: Optional[str] = Field(
        None,
        title="The actual UTF-8 text of the message"
    )
...
video or voice"
    ...
    audio: Optional[Audio] = Field(
        None,
        title="Message is an audio file, information about the file"
    )
    document: Optional[Document] = Field(
        None,
        title="Message is a general file, information about the file"
    )
    photo: Optional[List[Photo]] = Field(
        None,
        title="Message is a photo, available sizes of the photo"
    )
    sticker: Optional[Sticker] = Field(
        None,
        title="Message is a sticker, information about the sticker"
    )
    video: Optional[Video] = Field(
        None,
        title="Message is a video, information about the video"
    )
...
video message"
    ...
    voice: Optional[Voice] = Field(
        None,
        title="Message is a voice message, information about the file"
    )
    contact: Optional[Contact] = Field(
        None,
        title="Message is a shared contact, information about the contact"
    )
...
class CallbackQuery(BaseModel):
    ...
    message: Optional[Message] = Field(
        None,
        title="Message with the callback button that originated the query"
    )
...
which the message with the callback button was sent",
    ...
    data: Optional[str] = Field(
        None,
        title="Data associated with the callback button"
    )
