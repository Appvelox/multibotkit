...
def test_syncUploadPhoto(httpx_mock: HTTPXMock):
    ...
    r = vk_helper.syncUploadPhoto(photo=image, file_name="photo.img" , server_url="https://server_url")
...
async def test_asyncUploadPhoto(httpx_mock: HTTPXMock):
    ...
    r = await vk_helper.asyncUploadPhoto(photo=image, file_name="photo.img" , server_url="https://server_url")
