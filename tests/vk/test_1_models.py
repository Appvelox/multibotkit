...
def test_icoming_models():
    ...
    client_info = ClientInfo.model_validate(client_info_dict)
    ...
    coordinates_object_json = coordinates_object.model_dump_json()
    ...
    coordinates_object = CoordinatesObject.model_validate(coordinates_object_dict)
    ...
    geo_object_json = geo_object.model_dump_json()
    ...
    geo_object = GeoObject.model_validate(geo_object_dict)
    ...
    message_object_json = message_object.model_dump_json()
    ...
    message_object = MessageObject.model_validate(message_object_dict)
    ...
    event_object_json = event_object.model_dump_json()
    ...
    event_object = EventObject.model_validate(event_object_dict)
    ...
    incoming_event_json = incoming_event.model_dump_json()
...
def test_outgoing_models():
    ...
    keyboard_action_json = keyboard_action.model_dump_json()
    ...
    keyboard_action = KeyboardAction.model_validate(keyboard_action_dict)
    ...
    element_json = element.model_dump_json()
